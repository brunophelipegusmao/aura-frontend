...
const benefits = [
  "Salve produtos favoritos",
  "Acompanhe seus pedidos em tempo real",
  "Receba novidades de colecoes primeiro",
];
      ...
      <section className="relative left-1/2 right-1/2 w-screen -translate-x-1/2 overflow-hidden border-y border-secondary/15 bg-gradient-to-br from-paper via-accent/45 to-primary-soft/55 py-8 sm:py-10">
        <MotionReveal className="mx-auto w-full max-w-6xl px-3 sm:px-6 lg:px-8">
          ...
          <p className="mt-3 max-w-2xl text-sm text-muted md:text-base">
            Crie seu acesso para personalizar sua experiencia e comprar com mais
            rapidez.
          </p>
        </MotionReveal>
      </section>
        ...
        <div className="grid gap-4 lg:grid-cols-[1fr_minmax(0,1.1fr)] lg:gap-6">
          ...
          >
            ...
            <MotionStaggerItem>
              <p className="mt-2 text-sm text-muted">
                Um unico login para acompanhar toda sua jornada com a marca.
              </p>
            </MotionStaggerItem>
          ...
          <MotionReveal>
            <article className="rounded-3xl border border-secondary/20 bg-paper p-4 shadow-[0_14px_34px_rgba(11,11,15,0.1)] sm:p-5">
              ...
              <p className="mt-2 text-sm text-muted">
                Cadastre-se com Google ou preencha seus dados.
              </p>
              ...
              <form className="space-y-3">
                ...
                <label className="inline-flex items-start gap-2 pt-1 text-xs text-muted">
                  <input
                    required
                    type="checkbox"
                  ...
                  />
                  <span>
                    Concordo com os termos de uso e politica de privacidade da
                    Aura Activewear.
                  </span>
                </label>
